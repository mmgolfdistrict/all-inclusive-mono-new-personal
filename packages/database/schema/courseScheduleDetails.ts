...
export const courseScheduleDetails = mySqlTable("courseScheduleDetails", {
...
export type InsertCourseScheduleDetails = InferInsertModel<typeof courseScheduleDetails>;
