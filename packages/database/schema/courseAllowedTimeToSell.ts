...
export const courseAllowedTimeToSell = mySqlTable("courseAllowedTimeToSell", {
  ...
  return {
    courseDayTimeUniqueConstraint: unique("course_day_time_unique_constraint").on(table.courseId, table.day, table.fromTime, table.toTime),
