...
export const ModalWrapper: FC<ModalProps> = ({
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <motion.div
          className="fixed inset-0 flex items-center justify-center z-[101] bg-[#00000099]"
        ...
        >
          <motion.div
            className={`bg-white md:rounded-lg px-2 my-2 shadow-lg w-full transform border border-stroke text-left align-middle ${
              className ?? ""
            }`}
