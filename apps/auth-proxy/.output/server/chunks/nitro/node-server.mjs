...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/ManavGD/Documents/GolfDistrict_Project/all-inclusive-mono/apps/auth-proxy/.data/kv"}));
...
const _lazy_g9W9aX = () => import('../_...auth_.mjs');

const handlers = [
  { route: '', handler: _f4b49z, lazy: false, middleware: true, method: undefined },
  { route: '/**:auth', handler: _lazy_g9W9aX, lazy: true, middleware: false, method: undefined }
];
