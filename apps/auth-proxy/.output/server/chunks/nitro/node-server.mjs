...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/manavgd/Documents/all-inclusive-mono/apps/auth-proxy/.data/kv"}));
...
const _lazy_i3VPa2 = () => import('../_...auth_.mjs');

const handlers = [
  { route: '', handler: _f4b49z, lazy: false, middleware: true, method: undefined },
  { route: '/**:auth', handler: _lazy_i3VPa2, lazy: true, middleware: false, method: undefined }
];
