...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/manishpandey/Documents/updatedFolder/all-inclusive-mono/apps/auth-proxy/.data/kv"}));
...
const _lazy_O6IG4d = () => import('../_...auth_.mjs');

const handlers = [
  { route: '', handler: _f4b49z, lazy: false, middleware: true, method: undefined },
  { route: '/**:auth', handler: _lazy_O6IG4d, lazy: true, middleware: false, method: undefined }
];
