...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/manavgd/Documents/NewCloneForGolfDistrict/Golf_district_new_Code_for_next_js/all-inclusive-mono/apps/auth-proxy/.data/kv"}));
...
const _lazy_KOBl8d = () => import('../_...auth_.mjs');

const handlers = [
  { route: '', handler: _f4b49z, lazy: false, middleware: true, method: undefined },
  { route: '/**:auth', handler: _lazy_KOBl8d, lazy: true, middleware: false, method: undefined }
];
