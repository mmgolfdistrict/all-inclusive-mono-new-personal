...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/manavgd/Documents/NewCloneForGolfDistrict/newclone1/all-inclusive-mono/apps/auth-proxy/.data/kv"}));
...
const _lazy_83sK1Q = () => import('../_...auth_.mjs');

const handlers = [
  { route: '', handler: _f4b49z, lazy: false, middleware: true, method: undefined },
  { route: '/**:auth', handler: _lazy_83sK1Q, lazy: true, middleware: false, method: undefined }
];
