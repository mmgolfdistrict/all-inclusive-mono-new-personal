...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"D:\\golfdistrict\\all-inclusive-mono\\apps\\auth-proxy\\.data\\kv"}));
...
const _lazy_LRYkRZ = () => import('../_...auth_.mjs');

const handlers = [
  { route: '', handler: _f4b49z, lazy: false, middleware: true, method: undefined },
  { route: '/**:auth', handler: _lazy_LRYkRZ, lazy: true, middleware: false, method: undefined }
];
