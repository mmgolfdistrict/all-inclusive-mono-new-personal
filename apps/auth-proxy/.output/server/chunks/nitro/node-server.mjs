...
storage.mount(
  ...
  unstorage_47drivers_47fs_45lite({
    driver: "fsLite",
    base: "/Users/harshrathor/Desktop/all-inclusive-mono/apps/auth-proxy/.data/kv",
  })
);
...
const _lazy_VY4Y7X = () => import("../_...auth_.mjs");

const handlers = [
  { route: "", handler: _f4b49z, lazy: false, middleware: true, method: undefined },
  { route: "/**:auth", handler: _lazy_VY4Y7X, lazy: true, middleware: false, method: undefined },
];
