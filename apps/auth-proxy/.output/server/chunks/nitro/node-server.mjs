...
const _lazy_7ZGccN = () => import('../_...auth_.mjs');

const handlers = [
  { route: '', handler: _f4b49z, lazy: false, middleware: true, method: undefined },
  { route: '/**:auth', handler: _lazy_7ZGccN, lazy: true, middleware: false, method: undefined }
];
