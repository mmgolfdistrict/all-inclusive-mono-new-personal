...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/jigneshvyas/Desktop/Projects/all-inclusive-mono/apps/auth-proxy/.data/kv"}));
...
const _lazy_FcD6Rf = () => import('../_...auth_.mjs');

const handlers = [
  { route: '', handler: _f4b49z, lazy: false, middleware: true, method: undefined },
  { route: '/**:auth', handler: _lazy_FcD6Rf, lazy: true, middleware: false, method: undefined }
];
