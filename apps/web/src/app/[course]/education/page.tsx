    ...
    <>
      <section className="mx-auto px-2 flex w-full flex-col gap-4 pt-4 md:max-w-[1360px] md:px-6">
        ...
        <div className="col-span-3 flex flex-col items-start pl-4 md:px-6">
          <h1 className="text-[20px] capitalize text-secondary-black md:text-[30px]">
            You can now sell your tee times if plans change.{" "}
          </h1>
          <span className="text-[20px] capitalize md:text-[30px] text-gray-600">
            Book with freedom and comfort.
          </span>
          <div className="mt-8 w-full">
            <div className="flex items-center mb-6">
              <div className="flex-shrink-0 mr-4">
                <BookAdvance width={isMobile ? "25px" : "30px"} />
              </div>
              <div>
            ...
            <div className="flex items-center mb-6">
              <div className="flex-shrink-0 mr-4">
                <CloudyWithSun width={isMobile ? "25px" : "30px"} />
              </div>
              <div>
                <h2 className="text-[14px] md:text-[18px] font-semibold">
