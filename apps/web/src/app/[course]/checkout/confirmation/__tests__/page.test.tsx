    ...
    api: {
        systemNotification: {
            getSystemNotification: {
                useQuery: () => mockSystemNotificationQuery() as unknown[],
            },
            getCourseGlobalNotification: {
                useQuery: () => mockCourseGlobalNotificationQuery() as unknown[],
            },
        },
    },
}));
...
vi.mock("~/components/nav/checkout-breadcrumbs", () => ({
    CheckoutBreadcumbs: ({ status }: { status?: string }) => (
...
vi.mock("~/components/checkout-page/confirmation", () => ({
    Confirmation: (props: ConfirmationProps) => {
