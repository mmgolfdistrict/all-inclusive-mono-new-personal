...
vi.mock("~/components/cards/tee-time-details", () => ({
    TeeTimeDetails: ({ teeTimeId }: { teeTimeId: string }) => (
...
describe("TeeTimePage", () => {
    ...
    it("renders GoBack and TeeTimeDetails", async () => {
        (appSettingService.get as unknown as Mock).mockResolvedValue("false"); // hide transaction history
    ...
    it("renders TransactionHistory when setting is true", async () => {
        (appSettingService.get as unknown as Mock).mockResolvedValue("true");
    ...
    it("does not render TransactionHistory when setting is false", async () => {
        (appSettingService.get as unknown as Mock).mockResolvedValue("false");
