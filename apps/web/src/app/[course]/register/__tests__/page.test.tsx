...
import { toast, type ToastContent, type Id, type ToastOptions } from 'react-toastify';
...
vi.mock('react-toastify', () => ({
    toast: {
        // Use vi.fn() and cast to Mock<TFunction> (single argument)
        error: vi.fn() as Mock<ToastFunction>,
        success: vi.fn() as Mock<ToastFunction>,
    },
}));
// --- Mock Dependencies ---
...
describe('RegisterPage', () => {
    ...
    beforeEach(() => {
        ...
        // Mock window.google for Google Maps
    ...
    describe('Component Rendering', () => {
        ...
        it('should clear email and password fields on mount', () => {
            ...
            const emailInput = screen.getByTestId('register-email-id') as HTMLInputElement;
            const passwordInput = screen.getByTestId('register-password-id') as HTMLInputElement;
