        ...
        >
          ...
          >
            ...
            <g style={{ clipPath: "url(#clippath)" }}>
              <g id="c-1">
                <path d="M373,418.08c-.13,62.94-.26,125.87-.38,188.81-17.56,2.8-140.35,20.25-240.13-67.02C50.28,467.96,16.67,354,43.64,251.1,78.18,119.32,206.74,26.08,343.9,35.1c122.7,8.07,221.68,95.96,255.06,196.85,28.29,85.49,3.78,163.09-4.6,188.43-23.02,69.63-64.15,114.36-86.63,135.64" style={{ fill: "none", stroke: "#ffff", strokeLinejoin: "round", strokeWidth: "69px" }} />
              </g>
            </g>
            <g style={{ clipPath: "url(#clippath-1)" }}>
              <g id="line">
                <line x1="139.39" y1="302.42" x2="487.13" y2="302.42" style={{ fill: "#9c1a1c", stroke: "url(#linear-gradient)", strokeMiterlimit: "10", strokeWidth: "311px" }} />
              </g>
            </g>
            <g id="c-2">
              <polyline points="489.17 406.08 489.17 563.36 640.88 563.36" style={{ fill: "none", stroke: "#ffff", strokeLinejoin: "round", strokeWidth: "60px" }} />
            </g>
          </svg>
          <div
            style={{
