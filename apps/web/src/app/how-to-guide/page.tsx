...
export default function HowToGuide() {
  return (
    <main className="bg-secondary-white py-4 md:py-6 ">
      ...
      <section className="mx-auto flex w-full flex-col pt-4 md:max-w-[1360px] max-h-full md:gap-4 md:px-6">
        <h1 className="pb-4 text-center text-2xl text-secondary-black md:pb-0 md:text-3xl">
          How to Guide
        </h1>
        <section className="mx-auto flex w-full flex-col gap-4 md:max-w-[1174px] max-h-full">
          <iframe
            src="https://scribehow.com/page/Golf_District__How_to_Guide__Kg_zsvNST2C3xhJXdbeyog"
            title="Golf District How to Guide"
            className="mx-auto flex w-full flex-col gap-4 md:max-w-[1174px] max-h-full"
          ></iframe>
        </section>
      </section>
    </main>
