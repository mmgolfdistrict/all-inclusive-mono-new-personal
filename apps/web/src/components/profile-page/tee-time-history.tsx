...
export const TeeTimeHistory = ({
  ...
  return (
    <div className="flex w-full flex-col gap-4 bg-white md:rounded-xl">
      ...
      {!isLoading && error ? (
        <div className="flex flex-col items-center justify-center gap-4 px-4 pb-2 h-[12.5rem] text-[0.875rem] md:px-6 md:pb-3">
        ...
        <div className="flex max-w-full flex-col gap-4 overflow-auto px-4 pb-2 text-[0.875rem] md:px-6 md:pb-3">
  ...
  return (
    <tr className="w-full border-b border-stroke text-primary-gray">
      ...
      <td className="whitespace-nowrap px-4 py-3">
        <div className="h-6 w-[6.25rem] bg-gray-200 rounded-md animate-pulse" />
      </td>
    </tr>
  );
};
