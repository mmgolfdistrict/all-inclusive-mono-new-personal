...
vi.mock("../add-card", () => ({
    AddCard: ({ refetchCards }: { refetchCards: () => void }) => (
...
describe("AddCreditCard", () => {
    it("renders heading text", () => {
        (usePaymentMethods as any).mockReturnValue({ refetch: vi.fn() });
    ...
    it("passes refetch function from hook to AddCard", () => {
        ...
        (usePaymentMethods as any).mockReturnValue({ refetch: refetchMock });
